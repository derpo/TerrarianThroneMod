...
{
    public class SPCBallMed : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("SPCBallMedium");
        }
        ...
        public override void Kill(int timeLeft)
        {
            Main.PlaySound(2, (int)projectile.Center.X, (int)projectile.Center.Y, mod.GetSoundSlot(SoundType.Item, "Sounds/Item/PlasmaHit"));
            Player owner = Main.player[projectile.owner];
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("SPCBallSmall"), 100, 7, Main.myPlayer);
